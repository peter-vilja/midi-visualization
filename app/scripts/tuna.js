...
(function(window) {
  var userContext,
      ...
      Super = Object.create(null, {
        ...
        connect: {value: function(target) {
            this.output.connect(target);
          }},
        disconnect: {value: function(target) {
            this.output.disconnect(target);
          }},
        connectInOrder: {value: function(nodeArray) {
        ...
        automate: {value: function(property, value, duration, startTime) {
  ...
  Tuna.prototype.Cabinet.prototype = Object.create(Super, {
    ...
    newConvolver: {value: function(impulsePath) {
  ...
  Tuna.prototype.Overdrive.prototype = Object.create(Super, {
    ...
    waveshaperAlgorithms: {value: [function(amount, n_samples, ws_table) {
  ...
  Tuna.prototype.Phaser.prototype = Object.create(Super, {
    ...
    callback: {value: function(filters, value) {
  ...
  Tuna.prototype.WahWah.prototype = Object.create(Super, {
    ...
    activateCallback: {value: function(value) {
        this.automode = value;
      }},
    automode: {
      get: function() {
  ...
  Tuna.prototype.EnvelopeFollower.prototype = Object.create(Super, {
    ...
    activate: {value: function(doActivate) {
    ...
    returnCompute: {value: function(instance) {
  ...
  Tuna.prototype.LFO.prototype = Object.create(Super, {
    ...
    callback: {value: function(callback) {
        var that = this;
        return function() {
